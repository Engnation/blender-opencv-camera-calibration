...
''')
    #options = ([-c,-d,corners,debug_dir,json_file,sensor_size,square_size,threads)
    '''
    try:
    ...
    #file_type = "*.JPG"
    file_type = "*.png"
    #active_dir = "canon-efs-24mm-crop1.6"
    active_dir = "sample"

    image_dir = os.path.join(active_dir,file_type)
